...
from constants import fig_root, data_root, MODEL
from functions import load_model_test
...
if __name__ == "__main__":
    ...
    gt_label_folder =   f"{data_root}/labels/test/"  # Folder with ground truth YOLO labels (txt)
